...
export const ServiceBookingScreen = ({ navigation }) => {
  ...
  const renderHoursToggle = () => (
    <TouchableOpacity onPress={() => setVisibleHours(true)} style={{
      width: 75, height: 37, flexDirection: 'row', alignItems: 'center',
      borderColor: '#D9D8D8', borderWidth: 1, justifyContent: 'center'
    }}>
      <Text style={{ fontSize: 11, marginHorizontal: 2, color: '#828282', fontWeight: 'bold' }}>Hours</Text>
  ...
  const renderTimeToggle = () => (
    <TouchableOpacity onPress={() => setVisibleTime(true)} style={{
      width: 75, height: 37, flexDirection: 'row', alignItems: 'center',
      borderColor: '#D9D8D8', borderWidth: 1, justifyContent: 'center'
    }}>
      <Text style={{ fontSize: 11, marginHorizontal: 2, color: '#828282', fontWeight: 'bold' }}>Time</Text>
      <IconA style={[{ color: '#0DABA8', top: 2 }]} name='down' size={13} />
    </TouchableOpacity>
