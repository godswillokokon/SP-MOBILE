      ...
      <ImageBackground source={require('../assets/one.png')} style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <View style={{ width: 300, margin: 15, position: 'absolute', top: 300, zIndex: 1 }}>
          <Text style={{
            ...
            lineHeight: 42, marginVertical: 5,
          }}>Well Furnished Apartments</Text>
          <Text style={{ marginVertical: 5, fontSize: 20, color: '#fff', lineHeight: 23 }}>
            we always have you coverd, no stress. move into a well furnish and decorated house.
        </Text>
        </View>
      ...
      <ImageBackground source={require('../assets/two.png')} style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <View style={{ width: 300, margin: 15, position: 'absolute', top: 300, zIndex: 1 }}>
          <Text style={{
            ...
            lineHeight: 42, marginVertical: 5,
          }}>Affordable, to suit your budget</Text>
          <Text style={{ marginVertical: 5, fontSize: 20, color: '#fff', lineHeight: 23 }}>
            don't have enough money to purchase that dream home? let's save for it together with “spread save for property".
        </Text>
        </View>
      ...
      <ImageBackground source={require('../assets/three.png')} style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <View style={{ width: 300, margin: 15, position: 'absolute', top: 300, zIndex: 1 }}>
          <Text style={{
            fontSize: 40, color: '#fff',
            lineHeight: 42, marginVertical: 5,
          }}>Move easily from old to new houses</Text>
          <Text style={{ marginVertical: 5, fontSize: 20, color: '#fff', lineHeight: 23 }}>
            You no longer need to worry about moving all those heavy stuffs when relocating, we’ve got 24/7 reliable relocation team ready to serve you.
        </Text>
        </View>
        ...
        <View style={{
          ...
          <TouchableOpacity onPress={Login} style={{ position: 'absolute', right: 0, marginRight: 15, }}>
            <Text style={{ marginTop: 7, fontSize: 18, color: '#fff', }}>Get Started</Text>
          </TouchableOpacity>
