...
import {GetBoughtProps} from '../redux/actions/propsActions';
...
export const BoughtPropsScreen = ({navigation}) => {
  ...
  const isHouses = bought_houses.houses;
  const isLands = bought_houses.lands;
  ...
  const Title = () => (
    <View>
      <Text style={styles.title}>Bought Properties</Text>
    </View>
  );
  //sort
