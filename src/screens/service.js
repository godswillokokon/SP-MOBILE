  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{flex: 1, alignSelf: 'center', marginVertical: 24}}>
        <Image
          style={{width: Dimensions.get('screen').width - 20, height: 180}}
        ...
        <View
          ...
          <Text style={{color: '#3A3A3A', fontSize: 15, marginVertical: 9}}>
            {details.title}
          </Text>
          <Text style={{color: '#828282', fontSize: 13, lineHeight: 18}}>
            {details.info}
          </Text>
          <View
            style={{
            ...
            <Text style={{color: '#3A3A3A', fontSize: 15}}>
              {details.rate}/hr
            </Text>
          </View>
          <TouchableOpacity
            onPress={() => navigateService(details.title)}
            style={{
